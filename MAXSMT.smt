...
(assert (let ((a!1 (ite R2_BGP_IMPORT_Serial1_localpref_400
                ...
                (ite R2_BGP_IMPORT_Serial1_localpref_399
                     ...
                     (ite R2_BGP_IMPORT_Serial1_localpref_300
                          300
                          (ite R2_BGP_IMPORT_Serial1_localpref_100 200 500))))))
(let ((a!2 (ite true
...
(assert (let ((a!1 (ite R3_BGP_IMPORT_Serial0_localpref_400
                ...
                (ite R3_BGP_IMPORT_Serial0_localpref_399
                     ...
                     (ite R3_BGP_IMPORT_Serial0_localpref_300
                          300
                          (ite R3_BGP_IMPORT_Serial0_localpref_100 200 500))))))
(let ((a!2 (ite true
...
(assert-soft R2_BGP_IMPORT_Serial1_localpref_400 :weight 1 :id a)
(assert-soft (and (not (or (or false
                  R2_BGP_IMPORT_Serial1_localpref_100
                  R2_BGP_IMPORT_Serial1_localpref_300)
              R2_BGP_IMPORT_Serial1_localpref_399
              (not R2_BGP_IMPORT_Serial1_localpref_400)))
     (or (or false
             R2_BGP_IMPORT_Serial1_localpref_100
             R2_BGP_IMPORT_Serial1_localpref_300)
         R2_BGP_IMPORT_Serial1_localpref_399
         R2_BGP_IMPORT_Serial1_localpref_400)) :weight 1 :id a)
...
(assert-soft R3_BGP_IMPORT_Serial0_localpref_300 :weight 1 :id a)
(assert-soft (and (not (or false
              R3_BGP_IMPORT_Serial0_localpref_100
              (not R3_BGP_IMPORT_Serial0_localpref_300)
              R3_BGP_IMPORT_Serial0_localpref_399
              R3_BGP_IMPORT_Serial0_localpref_400))
     (or false
         R3_BGP_IMPORT_Serial0_localpref_100
         R3_BGP_IMPORT_Serial0_localpref_300
         R3_BGP_IMPORT_Serial0_localpref_399
         R3_BGP_IMPORT_Serial0_localpref_400)) :weight 1 :id a)
