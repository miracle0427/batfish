...
(declare-fun |0_0__R2_Loopback1_INBOUND_SOFTAdd| () Bool)
(declare-fun |0_0__R1_Loopback0_INBOUND_SOFTAdd| () Bool)
(declare-fun |1_1__R2_Serial1_INBOUND_SOFTAdd| () Bool)
(declare-fun |1_1__R2_Loopback0_INBOUND_SOFTAdd| () Bool)
(declare-fun |1_1__R2_Loopback1_INBOUND_SOFTAdd| () Bool)
(declare-fun |1_1__R1_Loopback0_INBOUND_SOFTAdd| () Bool)
...
(assert-soft |0_0__R2_Loopback1_OUTBOUND_SOFTAdd| :weight 1 :id a)
(assert-soft |0_0__R2_Loopback1_INBOUND_SOFTAdd| :weight 1 :id a)
...
(assert-soft |0_R2ImportFilterAddSoft0_R2_OSPF_IMPORT_Serial0| :weight 2 :id a)
(assert-soft |0_R2OSPFSoftRedisRemove| :weight 2 :id a)
(assert-soft |0_R2OSPFExportRemoveSoft192.168.42.0/24| :weight 3 :id a)
(assert-soft (not |0_R2OSPFExportAddSoft39.39.39.0/24|) :weight 20 :id a)
(assert-soft (not |0_R2OSPFExportAddSoft180.0.0.0/24|) :weight 20 :id a)
(assert-soft (not |0_R2OSPFExportAddSoft69.69.69.0/24|) :weight 20 :id a)
(assert-soft |0_R1ImportFilterAddSoft0_R1_OSPF_IMPORT_Serial0| :weight 2 :id a)
(assert-soft |0_R1OSPFExportRemoveSoft192.168.42.0/24| :weight 3 :id a)
(assert-soft |0_R1OSPFExportRemoveSoft70.70.70.0/24| :weight 3 :id a)
...
(assert-soft |1_1__R2_Serial1_OUTBOUND_SOFTAdd| :weight 1 :id a)
(assert-soft |1_1__R2_Serial1_INBOUND_SOFTAdd| :weight 1 :id a)
(assert-soft |1_1__R2_Loopback0_OUTBOUND_SOFTAdd| :weight 1 :id a)
(assert-soft |1_1__R2_Loopback0_INBOUND_SOFTAdd| :weight 1 :id a)
(assert-soft |1_1__R2_Loopback1_OUTBOUND_SOFTAdd| :weight 1 :id a)
(assert-soft |1_1__R2_Loopback1_INBOUND_SOFTAdd| :weight 1 :id a)
(assert-soft |1_1__R2_Serial0_OUTBOUND_SOFTAdd| :weight 1 :id a)
(assert-soft |1_1__R2_Serial0_INBOUND_SOFTAdd| :weight 1 :id a)
(assert-soft |1_1__R1_Serial0_OUTBOUND_SOFTAdd| :weight 1 :id a)
(assert-soft |1_1__R1_Serial0_INBOUND_SOFTAdd| :weight 1 :id a)
(assert-soft |1_1__R1_Loopback0_OUTBOUND_SOFTAdd| :weight 1 :id a)
(assert-soft |1_1__R1_Loopback0_INBOUND_SOFTAdd| :weight 1 :id a)
(assert-soft |1_R2ImportFilterAddSoft1_R2_OSPF_IMPORT_Serial0| :weight 2 :id a)
(assert-soft (not |1_R2OSPFExportAddSoft39.39.39.0/24|) :weight 20 :id a)
(assert-soft (not |1_R2OSPFExportAddSoft180.0.0.0/24|) :weight 20 :id a)
(assert-soft (not |1_R2OSPFExportAddSoft69.69.69.0/24|) :weight 20 :id a)
(assert-soft |1_R1ImportFilterAddSoft1_R1_OSPF_IMPORT_Serial0| :weight 2 :id a)
(assert-soft (not |1_R2-StaticRouteAdd-R2,Serial0 --> R1,Serial0|) :weight 3 :id a)
(assert-soft (not |1_R1-StaticRouteAdd-R1,Serial0 --> R2,Serial0|) :weight 3 :id a)
(check-sat)
(get-objectives)
