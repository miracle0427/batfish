...
(declare-fun |0_A_STATIC_BEST_None_prefixLength| () Int)
...
(declare-fun |0_A_STATIC_IMPORT_GigabitEthernet0/1_prefixLength| () Int)
...
(declare-fun |0_A_STATIC_IMPORT_GigabitEthernet0/1_permitted| () Bool)
(declare-fun AStaticRouteRemove103.0.3.3/8 () Bool)
...
(assert (>= |0_A_STATIC_BEST_None_prefixLength| 0))
(assert (<= |0_A_STATIC_BEST_None_prefixLength| 32))
...
(assert (>= |0_A_STATIC_IMPORT_GigabitEthernet0/1_prefixLength| 0))
(assert (<= |0_A_STATIC_IMPORT_GigabitEthernet0/1_prefixLength| 32))
...
(assert (ite (and true
          ...
          (= |0_FAILED-EDGE_A_B| 0)
          AStaticRouteRemove103.0.3.3/8)
     (and |0_A_STATIC_IMPORT_GigabitEthernet0/1_permitted|
          (= |0_A_STATIC_IMPORT_GigabitEthernet0/1_prefixLength| 8)
          true
          true
          true)
     (not |0_A_STATIC_IMPORT_GigabitEthernet0/1_permitted|)))
...
(let ((a!4 (or (> |0_A_STATIC_BEST_None_prefixLength|
                  |0_A_STATIC_IMPORT_GigabitEthernet0/1_prefixLength|)
               (and (= |0_A_STATIC_BEST_None_prefixLength|
                       |0_A_STATIC_IMPORT_GigabitEthernet0/1_prefixLength|)
                    (or false (and true a!3))))))
  (=> |0_A_STATIC_IMPORT_GigabitEthernet0/1_permitted| a!4))))))
(assert (= |0_A_STATIC_IMPORT_GigabitEthernet0/1_permitted|
   |0_A_STATIC_BEST_None_permitted|))
(assert (=> |0_A_STATIC_IMPORT_GigabitEthernet0/1_permitted|
    (and |0_A_STATIC_IMPORT_GigabitEthernet0/1_permitted|
         (= |0_A_STATIC_BEST_None_prefixLength|
            |0_A_STATIC_IMPORT_GigabitEthernet0/1_prefixLength|)
         true
         true
         true
...
(let ((a!4 (and (= |0_C_OSPF_BEST_None_prefixLength|
  ...
  (=> |0_C_OSPF_IMPORT_GigabitEthernet0/2_permitted|
      (or (> |0_C_OSPF_BEST_None_prefixLength|
             |0_C_OSPF_IMPORT_GigabitEthernet0/2_prefixLength|)
          a!4)))))))
(assert (= |0_C_OSPF_IMPORT_GigabitEthernet0/2_permitted|
   |0_C_OSPF_BEST_None_permitted|))
(assert (=> |0_C_OSPF_IMPORT_GigabitEthernet0/2_permitted|
...
(assert (= |0_A_OSPF_IMPORT_GigabitEthernet0/1_choice|
   (and |0_A_OSPF_IMPORT_GigabitEthernet0/1_permitted|
        ...
        true
        true)))
(assert (= |0_A_STATIC_IMPORT_GigabitEthernet0/1_choice|
   (and |0_A_STATIC_IMPORT_GigabitEthernet0/1_permitted|
        (= |0_A_STATIC_BEST_None_prefixLength|
           |0_A_STATIC_IMPORT_GigabitEthernet0/1_prefixLength|)
        true
...
(let ((a!4 (and (= |0_A_OVERALL_BEST_None_prefixLength|
                   |0_A_STATIC_BEST_None_prefixLength|)
                (or (< |0_A_OVERALL_BEST_None_adminDist| 1)
                    (and (= |0_A_OVERALL_BEST_None_adminDist| 1) (or false a!3))))))
  (=> |0_A_STATIC_BEST_None_permitted|
      (or (> |0_A_OVERALL_BEST_None_prefixLength|
             |0_A_STATIC_BEST_None_prefixLength|)
          a!4)))))))
(assert (= (or |0_A_OSPF_BEST_None_permitted| |0_A_STATIC_BEST_None_permitted|)
...
(assert (=> (or |0_A_OSPF_BEST_None_permitted| |0_A_STATIC_BEST_None_permitted|)
    (or (and |0_A_OSPF_BEST_None_permitted|
             ...
             true
             true)
        (and |0_A_STATIC_BEST_None_permitted|
             (= |0_A_OVERALL_BEST_None_prefixLength|
                |0_A_STATIC_BEST_None_prefixLength|)
             (= |0_A_OVERALL_BEST_None_adminDist| 1)
             true
...
(assert (=> (and true
         |0_A_STATIC_IMPORT_GigabitEthernet0/1_choice|
         (= |0_A_OVERALL_BEST_None_prefixLength|
            |0_A_STATIC_IMPORT_GigabitEthernet0/1_prefixLength|)
         (= |0_A_OVERALL_BEST_None_adminDist| 1)
         true
         ...
         true)
    |0_CONTROL-FORWARDING_A_GigabitEthernet0/1|))
(assert (not |0_CONTROL-FORWARDING_A_GigabitEthernet0/2|))
...
(assert (=> (not |0_A_STATIC_BEST_None_permitted|)
    (= |0_A_STATIC_BEST_None_prefixLength| 0)))
...
(assert (=> (not |0_A_STATIC_IMPORT_GigabitEthernet0/1_permitted|)
    (= |0_A_STATIC_IMPORT_GigabitEthernet0/1_prefixLength| 0)))
...
(assert (not (or false
         (and (or false |0_DATA-FORWARDING_A_GigabitEthernet0/1|)
              true
              (not |0_DATA-FORWARDING_B_GigabitEthernet0/1|)))))
...
(assert-soft AStaticRouteRemove103.0.3.3/8 :weight 1 :id a)
