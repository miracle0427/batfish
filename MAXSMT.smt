...
(assert-soft |0__B_GigabitEthernet0/2_OUTBOUND_SOFTAdd| :weight 1 :id SoftOutAclAdd)
(assert-soft |0__C_GigabitEthernet0/3_OUTBOUND_SOFTAdd| :weight 1 :id SoftOutAclAdd)
(assert-soft |0__C_GigabitEthernet0/1_OUTBOUND_SOFTAdd| :weight 1 :id SoftOutAclAdd)
(assert-soft |0__A_GigabitEthernet0/3_INBOUND_SOFTAdd| :weight 1 :id SoftInAclAdd)
(assert-soft |0__A_GigabitEthernet0/4_INBOUND_SOFTAdd| :weight 1 :id SoftInAclAdd)
(assert-soft |0__A_GigabitEthernet0/1_INBOUND_SOFTAdd| :weight 1 :id SoftInAclAdd)
(assert-soft |0__B_GigabitEthernet0/1_INBOUND_SOFTAdd| :weight 1 :id SoftInAclAdd)
(assert-soft |0__B_GigabitEthernet0/2_INBOUND_SOFTAdd| :weight 1 :id SoftInAclAdd)
(assert-soft |0__C_GigabitEthernet0/3_INBOUND_SOFTAdd| :weight 1 :id SoftInAclAdd)
(assert-soft |0__C_GigabitEthernet0/1_INBOUND_SOFTAdd| :weight 1 :id SoftInAclAdd)
(assert-soft (let ((a!1 (and |0_A_OSPF_SINGLE-EXPORT__permitted|
                true
                true
                (= |0_A_OSPF_SINGLE-EXPORT__metric| 0)
                true
...
(assert-soft (let ((a!1 (and |0_B_OSPF_SINGLE-EXPORT__permitted|
                true
                true
                (= |0_B_OSPF_SINGLE-EXPORT__metric| 0)
                true
