...
(assert (or false (= (bvand |0_src-ip| #xffffffff) (bvand #x6a000203 #xffffffff))))
...
(assert-soft (not AOSPFExportAddSoft) :weight 1 :id OSPFExportAdd)
(assert-soft (not BOSPFExportAddSoft) :weight 1 :id OSPFExportAdd)
(check-sat)
