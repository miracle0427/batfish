...
(assert (= (and (or false |0_CONTROL-FORWARDING_A_GigabitEthernet0/2|) true)
   |0_DATA-FORWARDING_A_GigabitEthernet0/2|))
(assert (= (and (or false |0_CONTROL-FORWARDING_A_GigabitEthernet0/3|) true)
   |0_DATA-FORWARDING_A_GigabitEthernet0/3|))
(assert (= (and (or false |0_CONTROL-FORWARDING_A_GigabitEthernet0/4|) true)
   |0_DATA-FORWARDING_A_GigabitEthernet0/4|))
(assert (= (and (or false |0_CONTROL-FORWARDING_A_GigabitEthernet0/1|) true)
   |0_DATA-FORWARDING_A_GigabitEthernet0/1|))
(assert (= (and (or false |0_CONTROL-FORWARDING_B_GigabitEthernet0/1|) true)
   |0_DATA-FORWARDING_B_GigabitEthernet0/1|))
(assert (= (and (or false |0_CONTROL-FORWARDING_B_GigabitEthernet0/2|) true)
   |0_DATA-FORWARDING_B_GigabitEthernet0/2|))
(assert (= (and (or false |0_CONTROL-FORWARDING_B_GigabitEthernet0/3|) true)
   |0_DATA-FORWARDING_B_GigabitEthernet0/3|))
(assert (= (and (or false |0_CONTROL-FORWARDING_C_GigabitEthernet0/3|) true)
   |0_DATA-FORWARDING_C_GigabitEthernet0/3|))
(assert (= (and (or false |0_CONTROL-FORWARDING_C_GigabitEthernet0/2|) true)
   |0_DATA-FORWARDING_C_GigabitEthernet0/2|))
(assert (= (and (or false |0_CONTROL-FORWARDING_C_GigabitEthernet0/1|) true)
