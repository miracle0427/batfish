...
(assert (>= |0_A_OSPF_EXPORT_GigabitEthernet0/1_metric| 0))
(assert (< |0_A_OSPF_EXPORT_GigabitEthernet0/1_metric| 65536))
(assert (>= |0_A_OSPF_EXPORT_GigabitEthernet0/1_prefixLength| 0))
(assert (<= |0_A_OSPF_EXPORT_GigabitEthernet0/1_prefixLength| 32))
...
(assert (>= |0_B_OSPF_EXPORT_GigabitEthernet0/1_metric| 0))
(assert (< |0_B_OSPF_EXPORT_GigabitEthernet0/1_metric| 65536))
(assert (>= |0_B_OSPF_EXPORT_GigabitEthernet0/1_prefixLength| 0))
(assert (<= |0_B_OSPF_EXPORT_GigabitEthernet0/1_prefixLength| 32))
...
(assert (>= |0_B_OSPF_EXPORT_GigabitEthernet0/2_metric| 0))
(assert (< |0_B_OSPF_EXPORT_GigabitEthernet0/2_metric| 65536))
(assert (>= |0_B_OSPF_EXPORT_GigabitEthernet0/2_prefixLength| 0))
(assert (<= |0_B_OSPF_EXPORT_GigabitEthernet0/2_prefixLength| 32))
...
(assert (>= |0_C_OSPF_EXPORT_GigabitEthernet0/1_metric| 0))
(assert (< |0_C_OSPF_EXPORT_GigabitEthernet0/1_metric| 65536))
(assert (>= |0_C_OSPF_EXPORT_GigabitEthernet0/1_prefixLength| 0))
(assert (<= |0_C_OSPF_EXPORT_GigabitEthernet0/1_prefixLength| 32))
...
(assert (let ((a!1 (ite (<= (+ |0_B_OSPF_EXPORT_GigabitEthernet0/1_metric| 1) 65535)
  ...
  (ite (and (not false)
       ...
       (not |0_A_OSPF_IMPORT_GigabitEthernet0/1_permitted|))))
(assert (let ((a!1 (and |0_A_OSPF_EXPORT_GigabitEthernet0/1_permitted|
                true
                true
...
(assert (let ((a!1 (ite (<= (+ |0_A_OSPF_EXPORT_GigabitEthernet0/1_metric| 1) 65535)
  ...
  (ite (and (not false)
       ...
       (not |0_B_OSPF_IMPORT_GigabitEthernet0/1_permitted|))))
(assert (let ((a!1 (and |0_B_OSPF_EXPORT_GigabitEthernet0/1_permitted|
                true
                true
...
(let ((a!4 (ite (and (and true true)
  ...
  (ite (and (and true true)
       ...
       (and |0_B_OSPF_EXPORT_GigabitEthernet0/1_permitted|
            ...
            true)
       a!4)))))
(assert (let ((a!1 (ite (<= (+ |0_C_OSPF_EXPORT_GigabitEthernet0/1_metric| 1) 65535)
  ...
  (ite (and (not false)
       ...
       (not |0_B_OSPF_IMPORT_GigabitEthernet0/2_permitted|))))
(assert (let ((a!1 (and |0_B_OSPF_EXPORT_GigabitEthernet0/2_permitted|
                true
                true
...
(let ((a!4 (ite (and (and true true)
  ...
  (ite (and (and true true)
       ...
       (and |0_B_OSPF_EXPORT_GigabitEthernet0/2_permitted|
            ...
            true)
       a!4)))))
(assert (let ((a!1 (ite (<= (+ |0_B_OSPF_EXPORT_GigabitEthernet0/2_metric| 1) 65535)
...
(assert (=> (not |0_A_OSPF_EXPORT_GigabitEthernet0/1_permitted|)
...
(assert (=> (not |0_B_OSPF_EXPORT_GigabitEthernet0/1_permitted|)
...
(assert (=> (not |0_B_OSPF_EXPORT_GigabitEthernet0/2_permitted|)
...
(assert (=> (not |0_C_OSPF_EXPORT_GigabitEthernet0/1_permitted|)
...
(assert-soft |0_BOSPFExportRemoveSoft106.0.0.0/8| :weight 3 :id a)
...
(assert-soft (not |0_A-StaticRouteAdd-A,GigabitEthernet0/1 --> B,GigabitEthernet0/1|) :weight 3 :id a)
(assert-soft (not |0_B-StaticRouteAdd-B,GigabitEthernet0/1 --> A,GigabitEthernet0/1|) :weight 3 :id a)
(assert-soft (not |0_B-StaticRouteAdd-B,GigabitEthernet0/2 --> C,GigabitEthernet0/1|) :weight 3 :id a)
(assert-soft (not |0_C-StaticRouteAdd-C,GigabitEthernet0/1 --> B,GigabitEthernet0/2|) :weight 3 :id a)
(check-sat)
(get-objectives)