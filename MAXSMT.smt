...
(assert (let ((a!1 (or (and (= ((_ extract 31 8) |0_dst-ip|) #x454545)
...
(let ((a!4 (and (= |0_R2_BGP_BEST_None_prefixLength|
  ...
  (=> |0_R1_BGP_SINGLE-EXPORT__permitted|
      (or (> |0_R2_BGP_BEST_None_prefixLength|
             |0_R1_BGP_SINGLE-EXPORT__prefixLength|)
          a!4)))))))
(assert (= |0_R1_BGP_SINGLE-EXPORT__permitted| |0_R2_BGP_BEST_None_permitted|))
...
(assert-soft (let ((a!1 (or (and (= ((_ extract 31 8) |0_dst-ip|) #x454545)
                    (not (= |0_R2_OVERALL_BEST_None_history| #b0)))
               (= |0_R2_OVERALL_BEST_None_history| #b0)))
      (a!2 (ite (and (= 24 24)
                     (= (bvand |0_dst-ip| #xffffff00)
