...
(declare-fun |0_R2_CONNECTED_IMPORT_Serial1_prefixLength| () Int)
...
(declare-fun R2ImportFilterAddSoft0_R2_OSPF_IMPORT_Serial0 () Bool)
...
(declare-fun R2OSPFExportRemoveSoft192.168.42.0/24 () Bool)
(declare-fun |0_dst-ip| () (_ BitVec 32))
(declare-fun R2OSPFExportAddSoft () Bool)
(declare-fun |0_R2_CONNECTED_IMPORT_Serial1_permitted| () Bool)
(declare-fun |0_R1_OSPF_IMPORT_Serial0_permitted| () Bool)
(declare-fun |0_R1_OSPF_IMPORT_Serial0_ospfType| () (_ BitVec 2))
(declare-fun R1ImportFilterAddSoft0_R1_OSPF_IMPORT_Serial0 () Bool)
(declare-fun |0_R1_OVERALL_BEST_None_ospfType| () (_ BitVec 2))
(declare-fun |0_R1_OVERALL_BEST_None_permitted| () Bool)
(declare-fun R1OSPFExportRemoveSoft192.168.42.0/24 () Bool)
(declare-fun R1OSPFExportRemoveSoft70.70.70.0/24 () Bool)
(declare-fun R1OSPFExportAddSoft () Bool)
(declare-fun |0_R2_CONNECTED_BEST_None_permitted| () Bool)
(declare-fun |0_R2_OSPF_IMPORT_Serial0_choice| () Bool)
(declare-fun |0_R2_CONNECTED_IMPORT_Serial1_choice| () Bool)
...
(assert (>= |0_R2_CONNECTED_IMPORT_Serial1_prefixLength| 0))
(assert (<= |0_R2_CONNECTED_IMPORT_Serial1_prefixLength| 32))
...
(assert (let ((a!1 (ite (<= (+ |0_R1_OSPF_SINGLE-EXPORT__metric| 1) 65535)
  ...
  (ite (and (not false)
            ...
            R2ImportFilterAddSoft0_R2_OSPF_IMPORT_Serial0)
...
(assert (let ((a!1 (and |0_R2_OSPF_Redistributed_permitted|
      ...
      (a!7 (ite true
                ...
                (not |0_R2_OSPF_SINGLE-EXPORT__permitted|))))
(let ((a!3 (and true (or false (and true (or false a!2))))))
(let ((a!4 (and true
                (or (< |0_R2_OSPF_Redistributed_metric|
                    ...
                    (and (= |0_R2_OSPF_Redistributed_metric|
                            |0_R2_OSPF_BEST_None_metric|)
                         (or false a!3))))))
(let ((a!5 (and (= |0_R2_OSPF_Redistributed_prefixLength|
                   |0_R2_OSPF_BEST_None_prefixLength|)
                (or (< |0_R2_OSPF_Redistributed_adminDist|
                    ...
                    (and (= |0_R2_OSPF_Redistributed_adminDist|
                            |0_R2_OSPF_BEST_None_adminDist|)
                         (or false a!4))))))
(let ((a!6 (not (and |0_R2_OSPF_Redistributed_permitted|
                     (or (> |0_R2_OSPF_Redistributed_prefixLength|
                            |0_R2_OSPF_BEST_None_prefixLength|)
                         a!5)))))
(let ((a!8 (ite (and |0_R2_OSPF_BEST_None_permitted| a!6)
                ...
                (ite (and (and true true)
                     ...
                     (not |0_R2_OSPF_SINGLE-EXPORT__permitted|)))))
(let ((a!9 (ite (and (and true true)
                     (= (bvand |0_dst-ip| #xffffff00)
                        (bvand #xc0a82a00 #xffffff00))
                     R2OSPFExportRemoveSoft192.168.42.0/24
                     (not a!1))
                (and |0_R2_OSPF_SINGLE-EXPORT__permitted|
                     true
                     ...
                     true)
                a!8)))
  (or R2OSPFExportAddSoft a!9)))))))))
(assert (ite (and true
          (= (bvand |0_dst-ip| #xffffff00) (bvand #xb4000000 #xffffff00))
          (= |0_FAILED-EDGE_R2_Serial1| 0))
     (and |0_R2_CONNECTED_IMPORT_Serial1_permitted|
          (= |0_R2_CONNECTED_IMPORT_Serial1_prefixLength| 24)
          true
          true
          true)
     (not |0_R2_CONNECTED_IMPORT_Serial1_permitted|)))
(assert (let ((a!1 (ite (<= (+ |0_R2_OSPF_SINGLE-EXPORT__metric| 1) 65535)
  ...
  (ite (and (not false)
            ...
            |0_R2_OSPF_SINGLE-EXPORT__permitted|
            (= |0_FAILED-EDGE_R1_R2| 0)
            R1ImportFilterAddSoft0_R1_OSPF_IMPORT_Serial0)
...
(let ((a!3 (ite (and (and true true)
                     (= (bvand |0_dst-ip| #xffffff00)
                        (bvand #xc0a82a00 #xffffff00))
                     R1OSPFExportRemoveSoft192.168.42.0/24)
                a!1
                (ite (and (and true true)
                          true
                          |0_R1_OVERALL_BEST_None_permitted|
...
(let ((a!4 (ite (and (and true true)
                     ...
                     R1OSPFExportRemoveSoft70.70.70.0/24)
                a!1
                a!3)))
  (or R1OSPFExportAddSoft a!4)))))
...
(let ((a!4 (or (> |0_R2_CONNECTED_BEST_None_prefixLength|
                  |0_R2_CONNECTED_IMPORT_Serial1_prefixLength|)
               (and (= |0_R2_CONNECTED_BEST_None_prefixLength|
                       |0_R2_CONNECTED_IMPORT_Serial1_prefixLength|)
                    (or false (and true a!3))))))
  (=> |0_R2_CONNECTED_IMPORT_Serial1_permitted| a!4))))))
(assert (= |0_R2_CONNECTED_IMPORT_Serial1_permitted|
...
(assert (= |0_R2_OSPF_IMPORT_Serial0_choice|
   (and |0_R2_OSPF_IMPORT_Serial0_permitted|
        ...
        true
        true)))
(assert (= |0_R2_CONNECTED_IMPORT_Serial1_choice|
   (and |0_R2_CONNECTED_IMPORT_Serial1_permitted|
        (= |0_R2_CONNECTED_BEST_None_prefixLength|
           |0_R2_CONNECTED_IMPORT_Serial1_prefixLength|)
        true
...
(assert (=> (and (not (= |0_dst-ip| #xb4000001))
         |0_R2_CONNECTED_IMPORT_Serial1_choice|
         (= |0_R2_OVERALL_BEST_None_prefixLength|
            |0_R2_CONNECTED_IMPORT_Serial1_prefixLength|)
         (= |0_R2_OVERALL_BEST_None_adminDist| 0)
         true
...
(assert (let ((a!1 (not (and (not (= |0_dst-ip| #xb4000001))
                     |0_R2_CONNECTED_IMPORT_Serial1_choice|
                     (= |0_R2_OVERALL_BEST_None_prefixLength|
                        |0_R2_CONNECTED_IMPORT_Serial1_prefixLength|)
                     (= |0_R2_OVERALL_BEST_None_adminDist| 0)
                     ...
                     true
                     true))))
  (=> a!1 (not |0_CONTROL-FORWARDING_R2_Serial1|))))
(assert (=> (and true
...
(assert (=> (not |0_R2_CONNECTED_IMPORT_Serial1_permitted|)
    (= |0_R2_CONNECTED_IMPORT_Serial1_prefixLength| 0)))
...
(assert (or false (= (bvand |0_dst-ip| #xffffffff) (bvand #xb4000001 #xffffffff))))
...
(assert (=> (= (bvand |0_dst-ip| #xffffff00) (bvand #xc0a82a00 #xffffff00))
    (= |0_FAILED-EDGE_R1_R2| 0)))
(assert (= |0_FAILED-EDGE_R1_Loopback0| 0))
(assert-soft |0__R2_Serial1_OUTBOUND_SOFTAdd| :weight 10 :id a)
(assert-soft |0__R2_Serial1_INBOUND_SOFTAdd| :weight 10 :id a)
(assert-soft |0__R2_Loopback0_OUTBOUND_SOFTAdd| :weight 10 :id a)
(assert-soft |0__R2_Loopback0_INBOUND_SOFTAdd| :weight 10 :id a)
(assert-soft |0__R2_Serial0_OUTBOUND_SOFTAdd| :weight 10 :id a)
(assert-soft |0__R2_Serial0_INBOUND_SOFTAdd| :weight 10 :id a)
(assert-soft |0__R1_Serial0_OUTBOUND_SOFTAdd| :weight 10 :id a)
(assert-soft |0__R1_Serial0_INBOUND_SOFTAdd| :weight 10 :id a)
(assert-soft |0__R1_Loopback0_OUTBOUND_SOFTAdd| :weight 10 :id a)
(assert-soft |0__R1_Loopback0_INBOUND_SOFTAdd| :weight 10 :id a)
(assert-soft R2ImportFilterAddSoft0_R2_OSPF_IMPORT_Serial0 :weight 2 :id a)
(assert-soft R2OSPFSoftRedisRemove :weight 2 :id a)
(assert-soft R2OSPFExportRemoveSoft192.168.42.0/24 :weight 3 :id a)
(assert-soft (not R2OSPFExportAddSoft) :weight 10 :id a)
(assert-soft R1ImportFilterAddSoft0_R1_OSPF_IMPORT_Serial0 :weight 2 :id a)
(assert-soft R1OSPFExportRemoveSoft192.168.42.0/24 :weight 3 :id a)
(assert-soft R1OSPFExportRemoveSoft70.70.70.0/24 :weight 3 :id a)
(assert-soft (not R1OSPFExportAddSoft) :weight 10 :id a)
(check-sat)
