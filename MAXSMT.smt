...
(declare-fun R2ImportFilterAddSoft0_R2_BGP_IMPORT_Serial0 () Bool)
...
(declare-fun |69.69.69.0/24OSPF-ExportRemoveSoft0_R2_OVERALL_BEST_None| () Bool)
...
(declare-fun |22.22.22.0/24Stat-Conn-ExportRemoveSoft0_R1_OVERALL_BEST_None|
             ()
             Bool)
(declare-fun |42.42.42.0/24Stat-Conn-ExportRemoveSoft0_R1_OVERALL_BEST_None|
             ()
             Bool)
...
(let ((a!3 (ite (<= (ite true (+ |0_R2_OVERALL_BEST_None_metric| 1) 1) 255)
  ...
  (ite (and true
       ...
       (not |0_R2_BGP_SINGLE-EXPORT__permitted|))))))
(assert (let ((a!1 (or (and (= ((_ extract 31 8) |0_dst-ip|) #x2a2a2a)
                    |42.42.42.0/24Stat-Conn-ExportRemoveSoft0_R1_OVERALL_BEST_None|
                    (not (= |0_R1_OVERALL_BEST_None_history| #b0)))
               (and (= ((_ extract 31 8) |0_dst-ip|) #x161616)
                    |22.22.22.0/24Stat-Conn-ExportRemoveSoft0_R1_OVERALL_BEST_None|
                    (not (= |0_R1_OVERALL_BEST_None_history| #b0)))
               (= |0_R1_OVERALL_BEST_None_history| #b0)
               |0_R1_OVERALL_BEST_NoneBGPExportAddSoft|))
      (a!2 (ite (and (= 24 24)
                     (= (bvand |0_dst-ip| #xffffff00)
...
(assert (= |0_FAILED-EDGE_R1_Loopback1| 0))
(assert (= |0_FAILED-EDGE_R1_Loopback0| 0))
(assert-soft |0__R2_Loopback0_OUTBOUND_SOFTAdd| :weight 1 :id a)
(assert-soft |0__R2_Loopback0_INBOUND_SOFTAdd| :weight 10 :id a)
(assert-soft |0__R2_Serial0_OUTBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0__R2_Serial0_INBOUND_SOFTAdd| :weight 10 :id a)
(assert-soft |0__R1_Serial0_OUTBOUND_SOFTAdd| :weight 3 :id a)
(assert-soft |0__R1_Serial0_INBOUND_SOFTAdd| :weight 10 :id a)
(assert-soft |0__R1_Loopback1_OUTBOUND_SOFTAdd| :weight 4 :id a)
(assert-soft |0__R1_Loopback1_INBOUND_SOFTAdd| :weight 10 :id a)
(assert-soft |0__R1_Loopback0_OUTBOUND_SOFTAdd| :weight 5 :id a)
(assert-soft |0__R1_Loopback0_INBOUND_SOFTAdd| :weight 10 :id a)
(assert-soft |\|0_R1_BGP_SINGLE-EXPORT__prefixLength\|BGPRemoveFilter| :weight 6 :id a)
(assert-soft (not |\|0_R1_BGP_SINGLE-EXPORT__prefixLength\|BGPAddFilter|) :weight 1 :id a)
(assert-soft R2ImportFilterAddSoft0_R2_BGP_IMPORT_Serial0 :weight 7 :id a)
(assert-soft |69.69.69.0/24OSPF-ExportRemoveSoft0_R2_OVERALL_BEST_None| :weight 30 :id a)
(assert-soft (not |0_R2_OVERALL_BEST_NoneBGPExportAddSoft|) :weight 8 :id a)
(assert-soft |42.42.42.0/24Stat-Conn-ExportRemoveSoft0_R1_OVERALL_BEST_None| :weight 30 :id a)
(assert-soft |22.22.22.0/24Stat-Conn-ExportRemoveSoft0_R1_OVERALL_BEST_None| :weight 30 :id a)
(assert-soft (not |0_R1_OVERALL_BEST_NoneBGPExportAddSoft|) :weight 9 :id a)
(check-sat)
