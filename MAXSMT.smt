...
(declare-fun |0__A_GigabitEthernet0/3_INBOUND_SOFT| () Bool)
(declare-fun |0__C_GigabitEthernet0/3_INBOUND_SOFT| () Bool)
...
(assert (=> (= (bvand |0_dst-ip| #xffff0000) (bvand #x02000000 #xffff0000))
    (= |0_FAILED-EDGE_B_C| 0)))
(assert-soft |0__A_GigabitEthernet0/3_OUTBOUND_SOFT| :weight 1 :id SoftOutAcl)
(assert-soft |0__A_GigabitEthernet0/3_INBOUND_SOFT| :weight 1 :id SoftOutAcl)
(assert-soft |0__A_GigabitEthernet0/1_OUTBOUND_SOFT| :weight 1 :id SoftOutAcl)
(assert-soft |0__A_GigabitEthernet0/1_INBOUND_SOFT| :weight 1 :id SoftOutAcl)
(assert-soft |0__B_GigabitEthernet0/1_OUTBOUND_SOFT| :weight 1 :id SoftOutAcl)
(assert-soft |0__B_GigabitEthernet0/1_INBOUND_SOFT| :weight 1 :id SoftOutAcl)
(assert-soft |0__B_GigabitEthernet0/2_OUTBOUND_SOFT| :weight 1 :id SoftOutAcl)
(assert-soft |0__B_GigabitEthernet0/2_INBOUND_SOFT| :weight 1 :id SoftOutAcl)
(assert-soft |0__C_GigabitEthernet0/3_OUTBOUND_SOFT| :weight 1 :id SoftOutAcl)
(assert-soft |0__C_GigabitEthernet0/3_INBOUND_SOFT| :weight 1 :id SoftOutAcl)
(assert-soft |0__C_GigabitEthernet0/1_OUTBOUND_SOFT| :weight 1 :id SoftOutAcl)
(assert-soft |0__C_GigabitEthernet0/1_INBOUND_SOFT| :weight 1 :id SoftOutAcl)
(check-sat)
