...
(define-fun |0_0__A_GigabitEthernet0/4_OUTBOUND_SOFTAdd| () Bool
  true)
(define-fun |0_AOSPFExportRemoveSoft104.0.0.0/8| () Bool
  true)
...
(define-fun |0_src-port| () Int
  0)
(define-fun |0_C-StaticRouteAdd-C,GigabitEthernet0/1 --> B,GigabitEthernet0/2| () Bool
  false)
(define-fun |0_B-StaticRouteAdd-B,GigabitEthernet0/2 --> C,GigabitEthernet0/1| () Bool
  false)
...
(define-fun |0_0__A_GigabitEthernet0/3_OUTBOUND_SOFTAdd| () Bool
  true)
(define-fun |0_A-StaticRouteAdd-A,GigabitEthernet0/1 --> B,GigabitEthernet0/1| () Bool
  false)
(define-fun |0_AOSPFExportRemoveSoft1.0.0.0/16| () Bool
  true)
...
(define-fun |0_0__C_GigabitEthernet0/3_OUTBOUND_SOFTAdd| () Bool
  true)
(define-fun |0_COSPFExportAddSoft| () Bool
  false)
(define-fun |0_C-StaticRouteAdd-C,GigabitEthernet0/2 --> A,GigabitEthernet0/2| () Bool
  false)
...
(define-fun |1_1__B_GigabitEthernet0/2_INBOUND_SOFTAdd| () Bool
  true)
(define-fun |0_A-StaticRouteAdd-A,GigabitEthernet0/2 --> C,GigabitEthernet0/2| () Bool
  false)
(define-fun |0_B-StaticRouteAdd-B,GigabitEthernet0/1 --> A,GigabitEthernet0/1| () Bool
  false)
...
(define-fun |1_1__A_GigabitEthernet0/2_INBOUND_SOFTAdd| () Bool
  true)
(define-fun |0_AOSPFExportRemoveSoft3.0.0.0/16| () Bool
  true)
...
(define-fun |0_CONTROL-FORWARDING_A_GigabitEthernet0/2| () Bool
  false)
(define-fun |0_BOSPFExportAddSoft| () Bool
  false)
(define-fun |1_1__B_GigabitEthernet0/2_OUTBOUND_SOFTAdd| () Bool
  true)
(define-fun |0_AOSPFExportAddSoft| () Bool
  false)
...
(define-fun |1_1__A_GigabitEthernet0/3_OUTBOUND_SOFTAdd| () Bool
  true)
(define-fun |0_COSPFExportRemoveSoft3.0.0.0/16| () Bool
  true)
...
(define-fun |0_0__A_GigabitEthernet0/1_OUTBOUND_SOFTAdd| () Bool
  true)
(define-fun |0_BOSPFExportRemoveSoft2.0.0.0/16| () Bool
  true)
(define-fun |0_C_OSPF_SINGLE-EXPORT__prefixLength| () Int
  0)
(define-fun |0_COSPFExportRemoveSoft103.0.0.0/8| () Bool
  false)
...
(define-fun |0_A_OSPF_SINGLE-EXPORT__metric| () Int
  0)
(define-fun |0_BOSPFExportRemoveSoft1.0.0.0/16| () Bool
  true)
...
(define-fun |1_1__C_GigabitEthernet0/2_OUTBOUND_SOFTAdd| () Bool
  true)
(define-fun |0_COSPFExportRemoveSoft2.0.0.0/16| () Bool
  true)
