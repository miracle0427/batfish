    ...
    for (Entry<String, List<GraphEdge>> entry : getGraph().getEdgeMap().entrySet()) {
      ...
      for (GraphEdge ge : edges) {
        ...
        if (outbound != null) {// && existsACL(outbound)) {
          ...
          //ARCHIR ADD THIS BACK _outboundAcls.put(ge, outAcl);
          ///* ARCHIE REMOVE 
        ...
        if (inbound != null) {// && existsACL(inbound)) {
          ...
          // ARCHIE ADD THIS BACK _inboundAcls.put(ge, inAcl);
          ///* ARCHIE REMOVE 
      ...
      if (proto.isOspf() || proto.isBgp()) {
        ...
        if (ospfRedistribVars != null) {
          ...
          */
          ...
          // ARCHIE add back BoolExpr usable2 = mkAnd(active, doExport, ospfRedistribVars.getPermitted(), notFailed);
