...
(define-fun |0_R1_OSPF_SINGLE-EXPORT__permitted| () Bool
  true)
(define-fun R1OSPFExportRemoveSoft70.70.70.0/24 () Bool
  true)
...
(define-fun |0_R2_OSPF_Redistributed_permitted| () Bool
  true)
(define-fun R2OSPFExportAddSoft () Bool
  false)
...
(define-fun |0__R1_Serial0_OUTBOUND_SOFTAdd| () Bool
  true)
(define-fun |0__R2_Serial1_OUTBOUND_SOFTAdd| () Bool
  true)
(define-fun |0_R1_OVERALL_BEST_None_ospfType| () (_ BitVec 2)
  #b11)
(define-fun |0_icmp-code| () Int
  0)
(define-fun R2OSPFSoftRedisRemove () Bool
  true)
(define-fun R1OSPFExportAddSoft () Bool
  false)
...
(define-fun |0__R1_Loopback0_INBOUND_SOFTAdd| () Bool
  true)
(define-fun |0__R2_Serial1_INBOUND_SOFTAdd| () Bool
  true)
...
(define-fun |0__reachable-id_R1| () Int
  2)
(define-fun R2ImportFilterAddSoft0_R2_OSPF_IMPORT_Serial0 () Bool
  true)
...
(define-fun |0_R1_OSPF_SINGLE-EXPORT__prefixLength| () Int
  24)
(define-fun R1ImportFilterAddSoft0_R1_OSPF_IMPORT_Serial0 () Bool
  true)
...
(define-fun |0_R2_OSPF_IMPORT_Serial0_adminDist| () Int
  0)
(define-fun R2OSPFExportRemoveSoft192.168.42.0/24 () Bool
  true)
(define-fun R1OSPFExportRemoveSoft192.168.42.0/24 () Bool
  true)
...
(define-fun |0_R1_OSPF_IMPORT_Serial0_prefixLength| () Int
  24)
(define-fun |0_R2_CONNECTED_IMPORT_Serial1_prefixLength| () Int
  24)
...
(define-fun |0_R1_OSPF_IMPORT_Serial0_choice| () Bool
  true)
(define-fun |0_R2_CONNECTED_IMPORT_Serial1_choice| () Bool
  true)
...
(define-fun |0_R2_OSPF_IMPORT_Serial0_permitted| () Bool
  true)
(define-fun |0_R2_CONNECTED_IMPORT_Serial1_permitted| () Bool
  true)
