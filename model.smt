...
(define-fun AOSPFExportRemoveSoft1.0.0.0/16 () Bool
  true)
(define-fun AOSPFExportRemoveSoft105.0.0.0/8 () Bool
  true)
...
(define-fun |0_B_OSPF_IMPORT_GigabitEthernet0/1_prefixLength| () Int
  9)
(define-fun |0_A_CONNECTED_IMPORT_GigabitEthernet0/3_prefixLength| () Int
  8)
...
(define-fun |0_B_OSPF_IMPORT_GigabitEthernet0/1_choice| () Bool
  true)
(define-fun |0_A_CONNECTED_IMPORT_GigabitEthernet0/3_choice| () Bool
  true)
...
(define-fun |0_A_OSPF_IMPORT_GigabitEthernet0/1_permitted| () Bool
  true)
(define-fun |0_A_CONNECTED_IMPORT_GigabitEthernet0/3_permitted| () Bool
  true)
