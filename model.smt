(define-fun |0_dst-port| () Int
  0)
(define-fun DOSPFExportRemoveSoft4.0.0.0/16 () Bool
  true)
(define-fun |0_B_OSPF_IMPORT_GigabitEthernet0/1_prefixLength| () Int
  8)
(define-fun |0_A_OSPF_IMPORT_GigabitEthernet0/1_metric| () Int
  3)
(define-fun |0_D_OSPF_SINGLE-EXPORT__prefixLength| () Int
  8)
(define-fun |0_src-port| () Int
  0)
(define-fun |0_D_OVERALL_BEST_None_adminDist| () Int
  0)
...
(define-fun |0_B_OSPF_IMPORT_GigabitEthernet0/1_metric| () Int
  3)
(define-fun DOSPFExportRemoveSoft107.0.0.0/8 () Bool
  true)
(define-fun |0_D_OSPF_IMPORT_GigabitEthernet0/2_prefixLength| () Int
  8)
(define-fun CImportFilterAddSoft0_C_OSPF_IMPORT_GigabitEthernet0/2 () Bool
  true)
...
(define-fun |0__C_GigabitEthernet0/3_INBOUND_SOFTAdd| () Bool
  true)
(define-fun |0_D_OSPF_SINGLE-EXPORT__metric| () Int
  0)
...
(define-fun |C-StaticRouteAdd-C,GigabitEthernet0/2 --> A,GigabitEthernet0/2| () Bool
  false)
(define-fun |0_D_OVERALL_BEST_None_prefixLength| () Int
  8)
(define-fun |D-StaticRouteAdd-D,GigabitEthernet0/2 --> C,GigabitEthernet0/4| () Bool
  false)
(define-fun |0_B_OSPF_SINGLE-EXPORT__metric| () Int
  2)
(define-fun |0_CONTROL-FORWARDING_D_GigabitEthernet0/3| () Bool
  true)
...
(define-fun |0_icmp-code| () Int
  0)
(define-fun |0_C_STATIC_BEST_None_permitted| () Bool
  false)
...
(define-fun COSPFExportRemoveSoft3.0.0.0/16 () Bool
  true)
(define-fun |0_C_STATIC_BEST_None_prefixLength| () Int
  0)
(define-fun |0_B_OVERALL_BEST_None_prefixLength| () Int
  8)
(define-fun |0_icmp-type| () Int
  0)
(define-fun |0_D_OSPF_BEST_None_prefixLength| () Int
  8)
(define-fun AOSPFExportRemoveSoft3.0.0.0/16 () Bool
  true)
(define-fun |0_B_OSPF_IMPORT_GigabitEthernet0/2_permitted| () Bool
  true)
(define-fun |0_C_OVERALL_BEST_None_history| () (_ BitVec 1)
  #b0)
(define-fun |0__C_GigabitEthernet0/4_OUTBOUND_SOFTAdd| () Bool
  true)
...
(define-fun |A-StaticRouteAdd-A,GigabitEthernet0/2 --> C,GigabitEthernet0/2| () Bool
  false)
(define-fun |0_D_OVERALL_BEST_None_history| () (_ BitVec 1)
  #b1)
(define-fun CStaticRouteRemove107.0.4.3/8 () Bool
  false)
(define-fun |0_B_OSPF_SINGLE-EXPORT__permitted| () Bool
  true)
(define-fun AOSPFExportAddSoft () Bool
  false)
(define-fun |0_D_OSPF_SINGLE-EXPORT__permitted| () Bool
  true)
...
(define-fun |0__A_GigabitEthernet0/2_INBOUND_SOFTAdd| () Bool
  true)
(define-fun |0__D_GigabitEthernet0/3_OUTBOUND_SOFTAdd| () Bool
  true)
(define-fun |0_CONTROL-FORWARDING_D_GigabitEthernet0/2| () Bool
  false)
(define-fun |C-StaticRouteAdd-C,GigabitEthernet0/4 --> D,GigabitEthernet0/2| () Bool
  false)
(define-fun |0_C_OSPF_SINGLE-EXPORT__prefixLength| () Int
  8)
(define-fun |0_C_OSPF_IMPORT_GigabitEthernet0/1_metric| () Int
  3)
(define-fun |0_C_OSPF_IMPORT_GigabitEthernet0/4_permitted| () Bool
  true)
(define-fun |0__D_GigabitEthernet0/3_INBOUND_SOFTAdd| () Bool
  true)
...
(define-fun |0__A_GigabitEthernet0/1_INBOUND_SOFTAdd| () Bool
  true)
(define-fun |0_D_OVERALL_BEST_None_metric| () Int
  0)
...
(define-fun |0_C_OSPF_IMPORT_GigabitEthernet0/2_permitted| () Bool
  true)
(define-fun AImportFilterAddSoft0_A_OSPF_IMPORT_GigabitEthernet0/2 () Bool
  true)
(define-fun |0_C_OSPF_IMPORT_GigabitEthernet0/1_prefixLength| () Int
  8)
(define-fun |0_C_STATIC_IMPORT_GigabitEthernet0/1_prefixLength| () Int
  0)
(define-fun |0__D_GigabitEthernet0/2_OUTBOUND_SOFTAdd| () Bool
  true)
(define-fun |0_C_OSPF_IMPORT_GigabitEthernet0/2_prefixLength| () Int
  8)
(define-fun CImportFilterAddSoft0_C_OSPF_IMPORT_GigabitEthernet0/4 () Bool
  true)
(define-fun |0__on-loop_C_A| () Bool
  true)
...
(define-fun |B-StaticRouteAdd-B,GigabitEthernet0/2 --> C,GigabitEthernet0/1| () Bool
  false)
(define-fun |0_D_OSPF_BEST_None_metric| () Int
  2)
(define-fun BOSPFExportRemoveSoft1.0.0.0/16 () Bool
  true)
(define-fun |0__A_GigabitEthernet0/3_INBOUND_SOFTAdd| () Bool
  true)
(define-fun |0_C_OSPF_IMPORT_GigabitEthernet0/4_metric| () Int
  1)
(define-fun DImportFilterAddSoft0_D_OSPF_IMPORT_GigabitEthernet0/2 () Bool
  true)
(define-fun |0_D_OSPF_IMPORT_GigabitEthernet0/2_metric| () Int
  2)
(define-fun COSPFExportRemoveSoft4.0.0.0/16 () Bool
  true)
(define-fun |0_CONTROL-FORWARDING_B_GigabitEthernet0/1| () Bool
  false)
(define-fun |0__B_GigabitEthernet0/1_OUTBOUND_SOFTAdd| () Bool
  true)
(define-fun |0_D_CONNECTED_IMPORT_GigabitEthernet0/3_prefixLength| () Int
  8)
(define-fun |0__on-loop_C_C| () Bool
  false)
(define-fun |0__on-loop_C_D| () Bool
  false)
(define-fun |0__on-loop_C_B| () Bool
  true)
(define-fun |0_src-ip| () (_ BitVec 32)
  #x67000303)
(define-fun |0_DATA-FORWARDING_D_GigabitEthernet0/2| () Bool
  false)
(define-fun |0_DATA-FORWARDING_D_GigabitEthernet0/3| () Bool
  true)
...
(define-fun |0_DATA-FORWARDING_C_GigabitEthernet0/3| () Bool
  false)
(define-fun |0_DATA-FORWARDING_C_GigabitEthernet0/4| () Bool
  true)
...
(define-fun |0_CONTROL-FORWARDING_A_GigabitEthernet0/3| () Bool
  false)
(define-fun |0_D_OVERALL_BEST_None_permitted| () Bool
  true)
(define-fun |0_C_OVERALL_BEST_None_permitted| () Bool
  true)
(define-fun |0_D_CONNECTED_IMPORT_GigabitEthernet0/3_choice| () Bool
  true)
(define-fun |0_D_OSPF_IMPORT_GigabitEthernet0/2_choice| () Bool
  true)
(define-fun |0_C_STATIC_IMPORT_GigabitEthernet0/1_choice| () Bool
  false)
(define-fun |0_C_OSPF_IMPORT_GigabitEthernet0/2_choice| () Bool
  false)
(define-fun |0_C_OSPF_IMPORT_GigabitEthernet0/1_choice| () Bool
  false)
(define-fun |0_C_OSPF_IMPORT_GigabitEthernet0/4_choice| () Bool
  true)
...
(define-fun |0_A_OSPF_IMPORT_GigabitEthernet0/2_choice| () Bool
  true)
(define-fun |0_D_CONNECTED_BEST_None_permitted| () Bool
  true)
(define-fun |0_D_CONNECTED_BEST_None_prefixLength| () Int
  8)
(define-fun |0_D_OSPF_IMPORT_GigabitEthernet0/2_permitted| () Bool
  true)
(define-fun |0_C_STATIC_IMPORT_GigabitEthernet0/1_permitted| () Bool
  false)
