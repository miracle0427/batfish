(define-fun |0__reachable-id_B| () Int
  0)
(define-fun |0__C_GigabitEthernet0/3_INBOUND_SOFT| () Bool
  false)
(define-fun |0_A_OSPF_SINGLE-EXPORT__permitted| () Bool
  true)
(define-fun |0__C_GigabitEthernet0/1_INBOUND_SOFT| () Bool
  false)
(define-fun |0__A_GigabitEthernet0/1_OUTBOUND_SOFT| () Bool
  false)
...
(define-fun |0_A_OSPF_IMPORT_GigabitEthernet0/1_prefixLength| () Int
  8)
(define-fun |0__C_GigabitEthernet0/1_OUTBOUND_SOFT| () Bool
  false)
...
(define-fun |0_B_OSPF_IMPORT_GigabitEthernet0/1_metric| () Int
  3)
(define-fun |0__B_GigabitEthernet0/2_INBOUND_SOFT| () Bool
  false)
(define-fun |0_B_OVERALL_BEST_None_prefixLength| () Int
  8)
(define-fun |0__A_GigabitEthernet0/1_INBOUND_SOFT| () Bool
  false)
...
(define-fun |0_A_OVERALL_BEST_None_permitted| () Bool
  true)
(define-fun |0__B_GigabitEthernet0/2_OUTBOUND_SOFT| () Bool
  false)
(define-fun |0__C_GigabitEthernet0/3_OUTBOUND_SOFT| () Bool
  false)
(define-fun |0__A_GigabitEthernet0/3_OUTBOUND_SOFT| () Bool
  false)
...
(define-fun |0_B_OSPF_SINGLE-EXPORT__metric| () Int
  1)
(define-fun |0__A_GigabitEthernet0/3_INBOUND_SOFT| () Bool
  false)
(define-fun |0__B_GigabitEthernet0/1_OUTBOUND_SOFT| () Bool
  false)
...
(define-fun |0_C_OVERALL_BEST_None_prefixLength| () Int
  8)
(define-fun |0__B_GigabitEthernet0/1_INBOUND_SOFT| () Bool
  false)
