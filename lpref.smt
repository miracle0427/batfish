...
(declare-fun R2_BGP_IMPORT_Serial1_localpref_299 () Bool)
...
(declare-fun R3_BGP_IMPORT_Serial0_localpref_199 () Bool)
(declare-fun R3_BGP_IMPORT_Serial0_localpref_200 () Bool)
(declare-fun R3_BGP_IMPORT_Serial0_localpref_299 () Bool)
...
(assert (let ((a!1 (ite R2_BGP_IMPORT_Serial1_localpref_300
                300
                (ite R2_BGP_IMPORT_Serial1_localpref_299
                     299
                     (ite R2_BGP_IMPORT_Serial1_localpref_200
                          200
                          (ite R2_BGP_IMPORT_Serial1_localpref_199 199 301))))))
(let ((a!2 (ite true
                (ite (<= |0_R3_BGP_SINGLE-EXPORT__metric| 255)
                     (and (= |0_R2_BGP_IMPORT_Serial1_permitted|
                          ...
                          true
                          true
                          (= |0_R2_BGP_IMPORT_Serial1_localPref| 100)
...
(let ((a!3 (ite (<= (ite true (+ |0_R2_OVERALL_BEST_None_metric| 1) 1) 255)
  ...
  (ite (and true
       ...
       (not |0_R2_BGP_SINGLE-EXPORT__permitted|))))))
(assert (let ((a!1 (ite R3_BGP_IMPORT_Serial0_localpref_300
                300
                (ite R3_BGP_IMPORT_Serial0_localpref_299
                     299
                     (ite R3_BGP_IMPORT_Serial0_localpref_200
                          200
                          (ite R3_BGP_IMPORT_Serial0_localpref_199 199 301))))))
(let ((a!2 (ite true
...
(assert (=> (= (bvand |0_dst-ip| #xffffff00) (bvand #xc0a82c00 #xffffff00))
    (= |0_FAILED-EDGE_R1_R3| 0)))
(assert-soft |0_0__R2_Loopback0_OUTBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R2_Loopback0_INBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R2_Serial1_OUTBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R2_Serial1_INBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R2_Serial0_OUTBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R2_Serial0_INBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R3_Loopback0_OUTBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R3_Loopback0_INBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R3_Serial0_OUTBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R3_Serial0_INBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R3_Serial1_OUTBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R3_Serial1_INBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R1_Serial0_OUTBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R1_Serial0_INBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R1_Loopback0_OUTBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R1_Loopback0_INBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R1_Serial1_OUTBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft |0_0__R1_Serial1_INBOUND_SOFTAdd| :weight 2 :id a)
(assert-soft R2_BGP_IMPORT_Serial1_localpref_300 :weight 1 :id a)
(assert-soft (not (or false
         R2_BGP_IMPORT_Serial1_localpref_199
         R2_BGP_IMPORT_Serial1_localpref_200
         R2_BGP_IMPORT_Serial1_localpref_299
         (not R2_BGP_IMPORT_Serial1_localpref_300))) :weight 1 :id a)
(assert-soft |0_R2ImportFilterAddSoft0_R2_BGP_IMPORT_Serial1| :weight 6 :id a)
(assert-soft |0_69.69.69.0/24ExportRemoveSoft0_R2_OVERALL_BEST_None| :weight 7 :id a)
(assert-soft (not |0_0_R2_OVERALL_BEST_NoneBGPExportAddSoft|) :weight 7 :id a)
(assert-soft R3_BGP_IMPORT_Serial0_localpref_200 :weight 1 :id a)
(assert-soft (not (or false
         R3_BGP_IMPORT_Serial0_localpref_199
         (not R3_BGP_IMPORT_Serial0_localpref_200)
         R3_BGP_IMPORT_Serial0_localpref_299
         R3_BGP_IMPORT_Serial0_localpref_300)) :weight 1 :id a)
(assert-soft |0_R3ImportFilterAddSoft0_R3_BGP_IMPORT_Serial0| :weight 6 :id a)
(assert-soft |0_74.74.74.0/24Stat-Conn-ExportRemoveSoft0_R3_OVERALL_BEST_None| :weight 7 :id a)
(assert-soft (not |0_0_R3_OVERALL_BEST_NoneBGPExportAddSoft|) :weight 7 :id a)
(assert-soft |0_42.42.42.0/24ExportRemoveSoft0_R1_OVERALL_BEST_None| :weight 7 :id a)
(assert-soft (not |0_0_R1_OVERALL_BEST_NoneBGPExportAddSoft|) :weight 7 :id a)
(assert-soft (not |0_R2-StaticRouteAddSoft-R2,Serial1 --> R3,Serial0|) :weight 5 :id a)
(assert-soft (not |0_R2-StaticRouteAddSoft-R2,Serial0 --> R1,Serial0|) :weight 5 :id a)
(assert-soft (not |0_R3-StaticRouteAddSoft-R3,Serial0 --> R2,Serial1|) :weight 5 :id a)
(assert-soft (not |0_R3-StaticRouteAddSoft-R3,Serial1 --> R1,Serial1|) :weight 5 :id a)
(assert-soft (not |0_R1-StaticRouteAddSoft-R1,Serial0 --> R2,Serial0|) :weight 5 :id a)
(assert-soft (not |0_R1-StaticRouteAddSoft-R1,Serial1 --> R3,Serial1|) :weight 5 :id a)
(check-sat)
(get-objectives)
(get-model)